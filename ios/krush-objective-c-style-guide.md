# Krushtech Objective-C style guide.



This style guide is based off the [Ray Wenderlich Objective-C Style Guide](https://github.com/raywenderlich/objective-c-style-guide).
